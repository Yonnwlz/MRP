...
public class ContractDetail implements Serializable {
    ...
    private BigDecimal unitPrice;   //单价(元/含税)

    private String measureUnit;     //计量单位

    private BigDecimal sumPrice;    //总价(元/含税)

    private BigDecimal mixPrice;        //运杂费(元/含税)

    private BigDecimal otherPrice;  //其他(元/含税)

    private BigDecimal totalPrice;  //总计(元/含税)

    private String endDate;     //到货期

    private String address;     //交(提)货地点
