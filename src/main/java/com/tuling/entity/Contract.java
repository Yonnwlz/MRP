...
public class Contract implements Serializable {
    ...
    private BigDecimal contPrice;   //合同总金额

    private String transport;       //运费负担

    private String payWay;

    private String outPerm;     //预期千分比

    private String outDay;      //预期天数
    ...
    public String toString() {
        return "Contract{" +
                ...
                ", taxRate='" + taxRate + '\'' +
                ", wrapBack='" + wrapBack + '\'' +
                ", verifyStand='" + verifyStand + '\'' +
                ", mode='" + mode + '\'' +
                ", payCond='" + payCond + '\'' +
                ", verifyDate=" + verifyDate +
                ", qualityStand='" + qualityStand + '\'' +
